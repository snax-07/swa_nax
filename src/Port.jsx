                ...
                <div className='main-cont bg-[#161b22] flex flex-col lg:flex-col'>
                    <div className='left-cont flex flex-col bg-[#161b22] gap-4 lg:w-full'>
                        ...
                        <div className='profile-cont rounded-2xl bg-[#292e36] p-4 flex flex-col items-center gap-4'>
                            <div className='bg-red-300 pro-img-cont h-[100px] w-[100px] rounded-full border-[2px] border-[#0860ca]' >
                                <img className='bg-red-300 object-cover pro-img-cont h-[100px] w-[100px] rounded-full border-[2px] border-[#0860ca]' src={IMG_20240129_225159} />
                            </div>
